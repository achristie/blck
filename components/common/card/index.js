...
export default function Card({ title, body, img }) {
  return (
    <Link href={`/commodity/${title}`}>
      <a>
        <motion.div className="relative bg-slate-900 p-6 h-48 rounded-md border-2 group hover:-translate-y-1 transition ease-in-out delay-150 duration-300 hover:border-fuchsia-500 ">
